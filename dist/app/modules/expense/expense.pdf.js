...
exports.generateExpensePDF = generateExpensePDF;
const pdfkit_1 = __importDefault(require("pdfkit"));
function generateExpensePDF(reportData, res, email, name) {
    ...
    // Spacing under title
    doc.moveDown(0.8);
    // Thin horizontal line under the title
    doc
        .moveTo(60, doc.y)
        .lineTo(550, doc.y)
        .strokeColor('#000000')
    ...
    // Extra spacing before total row
    y += 12;
    // Total Row
    ...
    doc
        .fontSize(13)
        .font('Helvetica-Bold')
        .text('Total Expense', itemX + categoryPaddingLeft, totalTextY)
        .text(totalExpense.toFixed(2), amountX, totalTextY, {
        width: amountColumnWidth - 20,
        align: 'right',
    });
    doc.end();
