...
exports.extractDataFromRawText = void 0;
const extractDataFromRawText = (rawText) => {
    ...
    let amount;
    if (amountMatches) {
        const numericValues = amountMatches.map(val => parseFloat(val.replace(',', '.')));
...
exports.extractDataFromRawText = extractDataFromRawText;
