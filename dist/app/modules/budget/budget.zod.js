...
exports.updateBudgetCategoryZodSchema = exports.addBudgetCategoryZodSchema = exports.updateMonthlyBudgetZodSchema = exports.setMonthlyBudgetZodSchema = exports.updateBudgetZodSchema = exports.setBudgetZodSchema = void 0;
...
exports.setBudgetZodSchema = zod_1.z.object({
    body: zod_1.z
        ...
        .refine(data => (Array.isArray(data.categories) && data.categories.length > 0) ||
        data.totalBudget !== undefined, {
        message: 'Either categories (non-empty) or totalBudget must be provided',
    }),
});
...
exports.updateBudgetZodSchema = zod_1.z.object({
    body: zod_1.z
        ...
        message: 'Provide categories (non-empty) OR totalBudget OR (category identifier and amount)',
    }),
});
