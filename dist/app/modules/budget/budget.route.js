...
router
    ...
    .put((0, validateRequest_1.default)(budget_zod_1.updateBudgetZodSchema), budget_controller_1.updateBudget)
    .delete(budget_controller_1.deleteBudget); //actual working route
router
